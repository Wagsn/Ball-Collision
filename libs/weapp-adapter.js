...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TouchEvent = function TouchEvent(type) {
	  _classCallCheck(this, TouchEvent) //检查 this 是 TouchEvent 的实例，意思是不能采用 TouchEvent(type) 方式调用
	...
	function touchEventHandlerFactory(type) { // 返回一个 event handler 函数
	...
	wx.onTouchStart(touchEventHandlerFactory('touchstart'))  // 将自定义的handler绑定在wx上
